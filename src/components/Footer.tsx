...
const Footer = () => {
  const footerSections = [
    {
      title: 'Company',
      links: ['About Us', 'How It Works', 'Impact Data', 'Methodology']
    },
    {
      title: 'Get Started',
      links: ['Sign Up', 'Donate Boxes', 'Receive Boxes', 'Business Solutions']
    },
    {
      title: 'Resources',
      links: ['CO₂ Calculator', 'Sustainability Guide', 'Case Studies', 'Blog']
    },
    {
      title: 'Support',
      links: ['Help Center', 'Contact Us', 'Community', 'Partner Program']
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold">Reusa</h3>
                <p className="text-emerald-400 text-sm">Reimagine Shipping</p>
              </div>
            </div>
